...
class TestGeometery(unittest.TestCase):
    ...
    def test_point(self):
        ...
        self.assertEquals(str(point), str((0.0, 0.0, 0.0)))
        self.assertEquals(point.is_vector(), False)

    def test_vector(self):
        vector = point_3d(*self.coordinates[3])
        self.assertEquals(vector.is_vector(), True)
    ...
    def test_distance_between_points(self):
        ...
        self.assertEquals(distance_a_b, math.sqrt(3))
