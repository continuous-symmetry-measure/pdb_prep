...
class Test_pdb_info(unittest.TestCase):
    ...
    def setUp(self):
        self.pdb_dir = ["pdb_files", "pdb_utils_files"]
        self.pdb_1HFF = self.get_path('1HFF.pdb')
        self.pdb_1aib = self.get_path('1aib-3.pdb')
        self.pdb_4xia = self.get_path('4xia.pdb')
        self.pdb_2ZVK_missingRES = self.get_path('2ZVK_missingRES.pdb')
        self.pdb_5tor = self.get_path('5tor.pdb')  # 2v2h
        self.pdb_2v2h = self.get_path('2v2h.pdb')
