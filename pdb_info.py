...
@click.option('-a', '--chain-a', help='The chain id  of the first peptide', required=True)
@click.option('-b', '--chain-b', help='The chain id  of the second peptide', required=True)
